...
public class myzhongdiangongdetail extends Activity {
	private int btn_zhongdiangong_order_cancle_cle = 0;
	private int btn_zhongdiangong_order_confirm_cicle = 0;
	private int btn_zhongdiangong_order_confirm_cle = 0;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.myzhongdiangongdetail);
		...
		Log.d("zhongdiangongdetail", orderid);
		Log.d("zhongdiangongdetail", userid);
			...
			public void onClick(View v) {
				...
				(new Thread() {
					...
					public void run() {
						...
						// http get
						btn_zhongdiangong_order_cancle_cle = 0;
						for (btn_zhongdiangong_order_cancle_cle = 0; btn_zhongdiangong_order_cancle_cle < 1; btn_zhongdiangong_order_cancle_cle = btn_zhongdiangong_order_cancle_cle) {
							try {

								nameValuePairs.add(new BasicNameValuePair("userid", userid));
								nameValuePairs.add(new BasicNameValuePair("orderid", orderid));
								HttpClient httpclient = new DefaultHttpClient();
								HttpPost httppost = new HttpPost("http://www.sundaytek.com/deletezhongdiangongorder.php");
								httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs, "UTF-8"));
								HttpResponse response = httpclient.execute(httppost);
								HttpEntity entity = response.getEntity();
								btn_zhongdiangong_order_cancle_cle = 1;
		...
		(new Thread() {
			...
			public void run() {
				ArrayList<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>();
				// http get
				btn_zhongdiangong_order_confirm_cicle = 0;
				btn_zhongdiangong_order_confirm_cle = 0;
				for (btn_zhongdiangong_order_confirm_cle = 0; btn_zhongdiangong_order_confirm_cle < 1; btn_zhongdiangong_order_confirm_cle = btn_zhongdiangong_order_confirm_cle) {
					try {

						nameValuePairs.add(new BasicNameValuePair("userid", userid));
						nameValuePairs.add(new BasicNameValuePair("orderid", orderid));
						HttpClient httpclient = new DefaultHttpClient();
						HttpPost httppost = new HttpPost("http://www.sundaytek.com/selectzhongdiangongorder.php");
						httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs, "UTF-8"));
						HttpResponse response = httpclient.execute(httppost);
						HttpEntity entity = response.getEntity();
						is = entity.getContent();
						...
						Log.d("log_tag", "Error in http connection" + e.toString());
						btn_zhongdiangong_order_confirm_cicle = 1;
					}
					if (btn_zhongdiangong_order_confirm_cicle == 0) {
						...
						try {
							...
							is.close();
							result = sb.toString();
							btn_zhongdiangong_order_confirm_cle = 1;
