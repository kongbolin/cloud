					...
					if (btn_yuer_order_confirm_cicle == 0) {
						...
						try {
							...
							for (int i = 0; i < jArray.length(); i++) {
								...
								Log.d("otherneed", otherneed);
								address = address1;Log.d("address", address);
								contact = contact1;Log.d("contact", contact);
								phonenumber = phonenumber1;Log.d("phonenumber", phonenumber);
								sex = sex1;Log.d("sex", sex);
								age = age1;Log.d("age", age);
								zhujia = zhujia1;Log.d("zhujia", zhujia);
								// frequency = frequency1;
								// datestart = datestart1;
								// dateend = dateend1;
								price = price1;Log.d("price", price);
								pet = pet1;Log.d("pet", pet);
								Message msg = new Message();
								// 便我们做出不同的处理操作
								msg.what = 1;
