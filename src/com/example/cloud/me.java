...
public class me extends Activity implements OnClickListener {
	...
	private Button serverlet;

	@Override
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		// TODO Auto-generated method stub
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			AlertDialog.Builder alertDialog = new AlertDialog.Builder(me.this);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		read();
		serverlet = (Button) findViewById(R.id.serverlet);
		...
		serverlet.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				read();
				if (limit.equals("server")) {
					Intent intent = new Intent(me.this, myorder.class);
					// resultCode---请求码
					Bundle bundle = new Bundle(); // 创建Bundle对象
					// bundle.putString("something", temp_other); // 装入数据
					intent.putExtras(bundle);
	...
	public void onClick(View v) {
		...
		case R.id.older:
			if (o == 1) {
				Intent intentolder = new Intent(me.this, order.class);
