...
public class zhongdiangong extends Activity implements SeekBar.OnSeekBarChangeListener, Callback {
	private int back_zhongdiangong_int = 1;
	private int btn_zhongdiangong_ok_delete_cle = 0;
	private int chioce_content = 0;
	private int chioce_frequetly = 0;
	private int chioce_pet = 0;
	private int chioce_taste = 0;
	private LinearLayout layout_baojie;
	private LinearLayout layout_zuofan;
	private int btn_zhongdiangong_ok_cle = 0;
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if (keyCode == KeyEvent.KEYCODE_BACK) {
			AlertDialog.Builder alertDialog = new AlertDialog.Builder(zhongdiangong.this);
			alertDialog.setTitle("长期钟点工");
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btn_zhongdiangong_ok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (chioce_content == 0) {
					AlertDialog alertDialog = new AlertDialog.Builder(zhongdiangong.this).create();
					AlertDialog.Builder settingDialog = new AlertDialog.Builder(zhongdiangong.this);
					settingDialog.setInverseBackgroundForced(true);
					alertDialog.setMessage("请选择服务内容");
				...
				} else if (btn_baojie_i == -1 && text_mianjidaxiao_text.equals("无")) {
					AlertDialog alertDialog = new AlertDialog.Builder(zhongdiangong.this).create();
					AlertDialog.Builder settingDialog = new AlertDialog.Builder(zhongdiangong.this);
					settingDialog.setInverseBackgroundForced(true);
					...
					alertDialog.show();
				} else if (btn_zuofan_i == -1 && chioce_taste == 0) {
					AlertDialog alertDialog = new AlertDialog.Builder(zhongdiangong.this).create();
					AlertDialog.Builder settingDialog = new AlertDialog.Builder(zhongdiangong.this);
					settingDialog.setInverseBackgroundForced(true);
					...
					alertDialog.show();
				} else if (chioce_frequetly == 0) {

					AlertDialog alertDialog = new AlertDialog.Builder(zhongdiangong.this).create();
					AlertDialog.Builder settingDialog = new AlertDialog.Builder(zhongdiangong.this);
					settingDialog.setInverseBackgroundForced(true);
					alertDialog.setMessage("请选择服务频率");
					alertDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "知道了",
							new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
					...
					alertDialog.show();
				} else if (tempdatestart.equals("")) {
					AlertDialog alertDialog = new AlertDialog.Builder(zhongdiangong.this).create();
					AlertDialog.Builder settingDialog = new AlertDialog.Builder(zhongdiangong.this);
					settingDialog.setInverseBackgroundForced(true);
					alertDialog.setMessage("请选择开始时间");
					alertDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "知道了",
							new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
				...
				} else if (tempdateend.equals("")) {
					AlertDialog alertDialog = new AlertDialog.Builder(zhongdiangong.this).create();
					AlertDialog.Builder settingDialog = new AlertDialog.Builder(zhongdiangong.this);
					settingDialog.setInverseBackgroundForced(true);
					alertDialog.setMessage("请选择结束时间");
					alertDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "知道了",
							new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int which) {
				...
				} else if (text_zhongdiangong_contact_text.equals("")) {
					AlertDialog alertDialog = new AlertDialog.Builder(zhongdiangong.this).create();
					AlertDialog.Builder settingDialog = new AlertDialog.Builder(zhongdiangong.this);
					settingDialog.setInverseBackgroundForced(true);
				...
				} else if (text_zhongdiangong_phone_text.equals("")) {
					AlertDialog alertDialog = new AlertDialog.Builder(zhongdiangong.this).create();
					AlertDialog.Builder settingDialog = new AlertDialog.Builder(zhongdiangong.this);
					settingDialog.setInverseBackgroundForced(true);
					...
					temporderid = yearstr + monthstr + date1str + hourstr + minutestr + secondstr;
					...
					(new Thread() {
						...
						public void run() {
							...
							// "吴新初"));
							// 这里做网络操作
							for (btn_zhongdiangong_ok_cle = 0; btn_zhongdiangong_ok_cle < 1; btn_zhongdiangong_ok_cle = btn_zhongdiangong_ok_cle) {
								if (back_zhongdiangong_int == 1) {
									...
									try {
										...
										HttpPost httppost = new HttpPost(
												"http://www.sundaytek.com/insertorderzhongdiangong.php");
							...
							if (back_zhongdiangong_int == 1) {
								...
								btn_zhongdiangong_ok_delete_cle = 0;
								for (btn_zhongdiangong_ok_delete_cle = 0; btn_zhongdiangong_ok_delete_cle < 1; btn_zhongdiangong_ok_delete_cle = btn_zhongdiangong_ok_delete_cle) {
									try {
										...
										HttpClient httpclient = new DefaultHttpClient();
										HttpPost httppost = new HttpPost(
												"http://www.sundaytek.com/deletezhongdiangongorder.php");
										httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs, "UTF-8"));
										HttpResponse response = httpclient.execute(httppost);
										HttpEntity entity = response.getEntity();
										is = entity.getContent();
										btn_zhongdiangong_ok_delete_cle = 1;
										Log.e("log_tag", "isme ");
									} catch (Exception e) {
