	...
	protected void onCreate(Bundle savedInstanceState) {
				...
				(new Thread() {
					...
					public void run() {
						...
						try {
							...
							HttpPost httppost = new HttpPost("http://120.27.45.56/test.php");
		...
		btn_address_update.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// HttpPost("http://120.27.45.56/updateaddress.php");
			...
			public void onClick(View v) {
				...
				(new Thread() {
					...
					public void run() {
						...
						try {
							...
							// is = entity.getContent();
							HttpClient httpclient = new DefaultHttpClient();
							HttpPost httppost = new HttpPost("http://120.27.45.56/deleteaddress.php");
							httppost.setEntity(new UrlEncodedFormEntity(nameValuePairs, "UTF-8"));
							// httppost.setEntity(new
							// UrlEncodedFormEntity(nameValuePairs));
							HttpResponse response = httpclient.execute(httppost);
				...
				(new Thread() {
					...
					public void run() {
						...
						try {
							HttpClient httpclient = new DefaultHttpClient();
							HttpGet httpget = new HttpGet("http://120.27.45.56/test.php");
		...
		// btn_topfirst.setOnClickListener(new OnClickListener() {
		//
		// @Override
		// public void onClick(View v) {
		// // TODO Auto-generated method stub
		...
		// position, long id) {
		// // String txt="position:"+position+" id:"+id;
		// // FriendModel model = (FriendModel) mAdapter.getItem(position);
		// // Toast.makeText(address.this, model.getDescription(),
		// // 0).show();
		// }
		// });
	}
